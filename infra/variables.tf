...
variable "instance_guide_url" {
  description = <<-EOT
    Optional URL of the end-user guide, exposed in the discovery document as guide_url.
    Defaults to the published guide of the project; set to "" to omit it from the
    discovery document, or override with an instance-specific guide.
  EOT
  type        = string
  default     = "https://litote.github.io/amap-en-ligne/"
}
