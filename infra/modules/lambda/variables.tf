...
variable "instance_guide_url" {
  description = "Optional URL of the end-user guide (INSTANCE_GUIDE_URL env var). Exposed in the discovery document as guide_url so the app links directly to it."
  type        = string
  default     = ""
}
