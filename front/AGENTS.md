...
The complete design system (color tokens, typography, voice & tone, UI kit, SVG assets) lives in `.claude/skills/amap-en-ligne-design/`.

**Rule:** Invoke the `amap-en-ligne-design` skill before any work on screens or visual components.

Brand assets in `assets/`:
- `logo.svg` — Le Panier, square 96×96 viewBox (app icon, favicon)
- `wordmark.svg` — horizontal lockup 380×96 viewBox (home header)

Reference docs: `documentation/feature/fr/ui/charte-graphique.md` and ADR `documentation/architecture/adr-002-design-system.md`.
