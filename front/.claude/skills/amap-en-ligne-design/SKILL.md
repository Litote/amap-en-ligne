...
description: Use this skill to generate well-branded interfaces and assets for Amap en Ligne — a French open-source AMAP / CSA (Community-Supported Agriculture) management app — either for production or throwaway prototypes. Contains essential design guidelines, colors, type, fonts, assets, and UI kit components for prototyping. Use whenever building any visual artifact for Amap en Ligne (slides, prototypes, marketing pages, in-product UI).
user-invocable: true
---
