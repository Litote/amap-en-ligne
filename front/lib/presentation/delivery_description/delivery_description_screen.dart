...
class _DeliveryDescriptionView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => BlocConsumer<DeliveryDescriptionBloc, DeliveryDescriptionState>(
  ...
  Widget build(BuildContext context) => ListView.builder(
      ...
      itemBuilder: (context, i) {
        ...
        return ExpansionTile(
          ...
          children: product.supportedBasketSizes.map((basketSize) => _BasketSizeSection(
