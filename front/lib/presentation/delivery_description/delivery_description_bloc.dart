...
class DeliveryDescriptionBloc
  ...
  Future<void> _onRequested(
    ...
    try {
      ...
      // Catches both Exception and Error subtypes (e.g. StateError from
      // firstWhere when the delivery is not found in the org).
      unawaited(Sentry.captureException(e, stackTrace: stackTrace));
      emit(const DeliveryDescriptionState.error(message: kUnexpectedErrorMessage));
    }
  }
