...
class OrganizationCreationBloc
  ...
  static String _conflictMessage(
    ...
    OrganizationConflictField.organizationName => switch (existingStatus) {
      'PENDING_VALIDATION' =>
        'Une demande pour ce nom d\'AMAP est déjà en cours d\'examen.',
      'APPROVED' => 'Une AMAP avec ce nom a déjà été approuvée.',
      _ => 'Ce nom d\'AMAP est déjà utilisé.',
    },
    OrganizationConflictField.adminEmail => switch (existingStatus) {
      'PENDING_VALIDATION' =>
