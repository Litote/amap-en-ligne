            ...
            child: producerProducts.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isSelected = _selectedProductTypeIds.contains(
                        ...
                        children: [
                          CheckboxListTile(
                            ...
                            onChanged: (checked) {
                              setState(() {
                                if (checked == true) {
                                  _selectedProductTypeIds.add(
                                    product.productTypeId,
                                  );
                                } else {
                                  _selectedProductTypeIds.remove(
                                    product.productTypeId,
                                  );
                                  _selectedBasketSizes.remove(
                                    product.productTypeId,
                                  );
                                }
                              });
                          ...
                          if (isSelected &&
                              product.supportedBasketSizes.isNotEmpty)
                            Padding(
                                ...
                                children: product.supportedBasketSizes
                                    .map(
                                      (basketSize) => FilterChip(
                                        ...
                                        selected:
                                            _selectedBasketSizes[product
                                                    .productTypeId]
                                                ?.contains(basketSize.name) ??
                                            false,
                                        onSelected: (selected) {
                                          setState(() {
                                            final sizes = _selectedBasketSizes
                                                .putIfAbsent(
                                                  product.productTypeId,
                                                  () => {},
                                                );
