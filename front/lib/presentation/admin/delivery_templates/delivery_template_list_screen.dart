  ...
  Widget build(BuildContext context) {
    ...
    return ConnectedScaffold(
      ...
      body: StreamBuilder<Organization?>(
        ...
        builder: (context, organizationSnapshot) => BlocBuilder<DeliveryTemplateBloc, DeliveryTemplateState>(
...
class _TemplateTile extends StatelessWidget {
  ...
  Future<bool?> _confirmDelete(BuildContext context, int associationCount) => showDialog<bool>(
      context: context,
      useRootNavigator: true,
      builder: (dialogContext) => AlertDialog(
