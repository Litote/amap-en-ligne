...
class _DeliveryTemplateFormViewState extends State<_DeliveryTemplateFormView> {
  ...
  /// Updates the org's default delivery template id when this form toggles the
  /// default flag (or edits the current default). No-op otherwise.
  Future<void> _maybeUpdateDefaultTemplate(
    Organization organization,
    OrganizationRepository organizationRepository,
    DeliveryTemplate savedTemplate,
  ) async {
    final shouldUpdate =
        _isDefaultTemplate ||
  ...
  Future<void> _save(Organization organization) async {
    ...
    try {
      ...
      await _maybeUpdateDefaultTemplate(
        organization,
  ...
  String? _validateRequired(String? v) =>
      (v == null || v.trim().isEmpty) ? _kFieldRequired : null;

  String? _validateRequiredTime(TimeOfDay? value) =>
      value == null ? _kFieldRequired : null;
  ...
  String? _validateEarlyMaxVolunteers(String? v) {
    if (!_hasEarlySlot) return null;
    if (v == null || v.trim().isEmpty) return _kFieldRequired;
    final n = int.tryParse(v.trim());
    if (n == null || n < 1) return 'Entier positif requis.';
  ...
  void _onEarlySlotToggled(bool value) {
  ...
  List<Widget> _earlySlotFields() => [
    ...
    TextFormField(
      ...
      validator: _validateEarlyMaxVolunteers,
    ),
  ];
            ...
            child: ListView(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                  validator: _validateDesiredCount,
                ),
                const SizedBox(height: 16),
                _TimePickerField(
                ...
                SwitchListTile(
                  ...
                  value: _hasEarlySlot,
                  onChanged: _onEarlySlotToggled,
                  contentPadding: EdgeInsets.zero,
                ),
                if (_hasEarlySlot) ..._earlySlotFields(),
...
class _TimePickerField extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => FormField<TimeOfDay>(
    initialValue: value,
