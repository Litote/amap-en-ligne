...
class _RoleToggled implements UserManagementEvent {
  const _RoleToggled(this.role, {required this.isChecked});
...
as Role,isChecked: null == isChecked ? _self.isChecked : isChecked // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class _InviteRoleToggled implements UserManagementEvent {
  const _InviteRoleToggled(this.role, {required this.isChecked});
