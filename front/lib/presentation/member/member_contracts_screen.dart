                ...
                builder: (context, contractSnapshot) {
                  ...
                  final mine =
                      contracts
                        ...
                        ..sort(
                          (a, b) =>
                              a.minDeliveryDate.compareTo(b.minDeliveryDate),
                        );
                  final visible = mine
                      .where(
                        (contract) =>
                  ...
                  final activeContracts = visible
                      ...
                      .toList();
                  final upcomingContracts = visible
                      .where(
                        (contract) =>
                            contractStatusView(contract) ==
                      ...
                      children: [
                        ...
                        if (mine.isEmpty)
                          ...
                          _EmptyContractsState(
                            message: 'Aucun contrat dans cet état.',
                          )
                        else ...[
...
class _SharedBasketInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ordered =
        org == null ? const <Delivery>[] : contractDeliveriesOrdered(org, contract.contractId);
