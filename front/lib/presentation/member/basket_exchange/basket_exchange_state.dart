...
import 'package:amap_en_ligne/presentation/member/basket_exchange/basket_exchange_bloc.dart' show BasketExchangeBloc;
...
extension BasketExchangeReadyX on BasketExchangeReady {
  ...
  BasketExchangeRequest? myPendingRequestOn(BasketExchange offer) => offer.requests
        .where(
          (r) =>
