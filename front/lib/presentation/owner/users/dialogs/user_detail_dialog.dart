...
Future<void> showUserDetailDialog(BuildContext context, String userId) => showDialog<void>(
    context: context,
...
class _UserDetailDialog extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => BlocBuilder<UserDetailBloc, UserDetailState>(
