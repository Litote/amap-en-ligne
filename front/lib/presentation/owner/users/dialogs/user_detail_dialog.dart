  ...
  Widget build(
    ...
    builder: (context, state) => Dialog(
      ...
      child: ConstrainedBox(
        ...
        child: switch (state) {
          UserDetailInitial() || UserDetailLoading() => const _LoadingContent(),
          UserDetailNotFound() => const _NotFoundContent(),
          UserDetailError(:final message) => _ErrorContent(message: message),
  ...
  Widget build(BuildContext context) => SingleChildScrollView(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(_statusHeader(row), style: Theme.of(context).textTheme.bodySmall),
        const SizedBox(height: 16),
        // COMPTE section.
        _SectionCard(
          title: 'COMPTE',
