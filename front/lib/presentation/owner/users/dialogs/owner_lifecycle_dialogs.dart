...
const _kDeletionHeader = 'La suppression :\n';
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        FilledButton(
          ...
          onPressed: () => Navigator.of(context).pop(true),
          child: const Text(_kReactivateButtonLabel),
        ),
      ],
    );
  }
    ...
    return AlertDialog(
      ...
      actions: [
        ...
        FilledButton(
          ...
          child: const Text(_kDeleteButtonLabel),
        ),
      ],
    );
  }
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            "$_kDeletionHeader  • supprime tous les comptes utilisateurs Producteur liés $_kSessionsInvalidated"
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            "$_kDeletionHeader  • supprime le compte du fournisseur d'authentification $_kSessionsInvalidated"
