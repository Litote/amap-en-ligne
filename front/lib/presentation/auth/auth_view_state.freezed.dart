...
mixin _$AuthViewState {
 ...
 bool get initializing; bool get submitting; bool get logoutRequested; String? get producerId; String? get producerAccountId; String? get organizationId; bool get isAdmin; UserRole get role; Set<Role> get memberRoles; String? get firstName; String? get lastName; AuthError? get lastError;
...
@useResult
$Res call({
 bool initializing, bool submitting, bool logoutRequested, String? producerId, String? producerAccountId, String? organizationId, bool isAdmin, UserRole role, Set<Role> memberRoles, String? firstName, String? lastName, AuthError? lastError
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool initializing,  bool submitting,  bool logoutRequested,  String? producerId,  String? producerAccountId,  String? organizationId,  bool isAdmin,  UserRole role,  Set<Role> memberRoles,  String? firstName,  String? lastName,  AuthError? lastError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthViewState() when $default != null:
return $default(_that.initializing,_that.submitting,_that.logoutRequested,_that.producerId,_that.producerAccountId,_that.organizationId,_that.isAdmin,_that.role,_that.memberRoles,_that.firstName,_that.lastName,_that.lastError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool initializing,  bool submitting,  bool logoutRequested,  String? producerId,  String? producerAccountId,  String? organizationId,  bool isAdmin,  UserRole role,  Set<Role> memberRoles,  String? firstName,  String? lastName,  AuthError? lastError)  $default,) {final _that = this;
switch (_that) {
case _AuthViewState():
return $default(_that.initializing,_that.submitting,_that.logoutRequested,_that.producerId,_that.producerAccountId,_that.organizationId,_that.isAdmin,_that.role,_that.memberRoles,_that.firstName,_that.lastName,_that.lastError);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool initializing,  bool submitting,  bool logoutRequested,  String? producerId,  String? producerAccountId,  String? organizationId,  bool isAdmin,  UserRole role,  Set<Role> memberRoles,  String? firstName,  String? lastName,  AuthError? lastError)?  $default,) {final _that = this;
switch (_that) {
case _AuthViewState() when $default != null:
return $default(_that.initializing,_that.submitting,_that.logoutRequested,_that.producerId,_that.producerAccountId,_that.organizationId,_that.isAdmin,_that.role,_that.memberRoles,_that.firstName,_that.lastName,_that.lastError);case _:
  return null;
...
/// Create a copy of AuthViewState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? initializing = null,Object? submitting = null,Object? logoutRequested = null,Object? producerId = freezed,Object? producerAccountId = freezed,Object? organizationId = freezed,Object? isAdmin = null,Object? role = null,Object? memberRoles = null,Object? firstName = freezed,Object? lastName = freezed,Object? lastError = freezed,}) {
