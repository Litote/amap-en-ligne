...
class UserPreferencesScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => BlocListener<UserPreferencesBloc, UserPreferencesState>(
  ...
  String _resolveUserId(BuildContext context) {
    ...
    if (currentState is Authenticated) {
      try {
        ...
        debugPrint('Failed to decode JWT claims for user ID resolution: $e');
      }
...
class _ProfileData {
  ...
  factory _ProfileData.fromContext(BuildContext context) {
    final authService = context.read<AuthService>();
    final currentState = authService.currentState;
    if (currentState is! Authenticated) {
  ...
  factory _ProfileData.fromMember(
    Member? member, {
  ...
  static String _extractEmail(JwtClaims claims) => claims.string('email') ??
        claims.nestedString('user_metadata.email') ??
        '—';

  static String _extractPhone(JwtClaims claims) => claims.nestedString('user_metadata.phone') ??
          ...
          children: [
            ...
            CheckboxListTile(
              ...
              onChanged: (v) => context.read<UserPreferencesBloc>().add(
                UserPreferencesEvent.alertToggled(
                  ...
                  value: v ?? mp.urgentNeedAlertsEnabled,
                ),
              ),
            ...
            CheckboxListTile(
              ...
              onChanged: (v) => context.read<UserPreferencesBloc>().add(
                UserPreferencesEvent.alertToggled(
                  ...
                  value: v ?? mp.incompleteSlotRemindersEnabled,
                ),
              ),
              title: const Text(
            ...
            CheckboxListTile(
              ...
              onChanged: (v) => context.read<UserPreferencesBloc>().add(
                UserPreferencesEvent.alertToggled(
                  ...
                  value: v ?? mp.planningChangesAlertsEnabled,
                ),
              ),
            ...
            CheckboxListTile(
              ...
              onChanged: (v) => context.read<UserPreferencesBloc>().add(
                UserPreferencesEvent.channelToggled(
                  ChannelField.push,
                  value: v ?? up.pushNotificationsEnabled,
                ),
              ),
            ...
            CheckboxListTile(
              ...
              onChanged: (v) => context.read<UserPreferencesBloc>().add(
                UserPreferencesEvent.channelToggled(
                  ChannelField.email,
                  value: v ?? up.emailNotificationsEnabled,
                ),
              ),
...
class _AlertTemplatesCardState extends State<_AlertTemplatesCard> {
  ...
  @override
  Widget build(BuildContext context) => BlocConsumer<AlertTemplatesBloc, AlertTemplatesState>(
