...
class _UserPreferencesAlertToggled implements UserPreferencesEvent {
  const _UserPreferencesAlertToggled(this.field, {required this.value});
...
null == field ? _self.field : field // ignore: cast_nullable_to_non_nullable
as AlertField,value: null == value ? _self.value : value // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
class _UserPreferencesChannelToggled implements UserPreferencesEvent {
  const _UserPreferencesChannelToggled(this.field, {required this.value});
...
null == field ? _self.field : field // ignore: cast_nullable_to_non_nullable
as ChannelField,value: null == value ? _self.value : value // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
