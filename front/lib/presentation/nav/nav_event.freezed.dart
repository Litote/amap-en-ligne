...
class NavRoleChanged implements NavEvent {
  const NavRoleChanged({required this.role, required  Set<Role> memberRoles}): _memberRoles = memberRoles;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is NavRoleChanged&&(identical(other.role, role) || other.role == role)&&const DeepCollectionEquality().equals(other.memberRoles, _memberRoles));
}


@override
int get hashCode {
    return Object.hash(runtimeType,role,const DeepCollectionEquality().hash(_memberRoles));
}
