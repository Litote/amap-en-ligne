...
class _CoordinatorMemberContractsScreenState
  ...
  Widget _buildMemberDetail(
    ...
    return _MemberContractDetail(
      ...
      onSelectionChanged: (contractId, selected) => _onContractSelectionChanged(
        contractId,
        selected,
        data.contracts,
        data.organization,
...
class _MemberContractDetail extends StatelessWidget {
  ...
  Widget _buildEditSubscriptions(Contract contract) {
    return Padding(
      ...
      children: [
        CheckboxListTile(
          ...
          onChanged: saving
              ? null
              : (value) =>
                    onSelectionChanged(contract.contractId, value ?? false),
          title: Text(contractProductLabel(contract, organization)),
