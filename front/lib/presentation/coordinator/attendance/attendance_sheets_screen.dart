        ...
        builder: (context, orgSnapshot) {
          ...
          return StreamBuilder<List<Contract>>(
            ...
            builder: (context, contractsSnapshot) => StreamBuilder<List<Member>>(
                ...
                builder: (context, membersSnapshot) => StreamBuilder<List<BasketExchange>>(
...
class _AttendanceSheetsBody extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => BlocBuilder<_AttendanceSheetsBloc, AttendanceSheetsState>(
