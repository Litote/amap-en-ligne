...
enum MutationErrorCode {
  ...
  /// Unexpected server-side failure while applying the mutation (persistence
  /// outage, bug). Transient: the mutation stays queued and is retried on a
  /// later sync instead of being dropped.
