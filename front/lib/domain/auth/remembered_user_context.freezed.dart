...
bool operator ==(Object other) {
  final _this = this as RememberedUserContext;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RememberedUserContext&&(identical(other.email, _this.email) || other.email == _this.email)&&(identical(other.serverId, _this.serverId) || other.serverId == _this.serverId)&&(identical(other.rememberMe, _this.rememberMe) || other.rememberMe == _this.rememberMe));
}
...
int get hashCode {
  final _this = this as RememberedUserContext;
  return Object.hash(runtimeType,_this.email,_this.serverId,_this.rememberMe);
}

@override
String toString() {
  final _this = this as RememberedUserContext;
  return 'RememberedUserContext(email: ${_this.email}, serverId: ${_this.serverId}, rememberMe: ${_this.rememberMe})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? serverId = null,Object? rememberMe = null,}) {
  return _then(RememberedUserContext(
...
@override
int get hashCode {
    return Object.hash(runtimeType,email,serverId,rememberMe);
}
