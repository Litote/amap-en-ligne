...
class Authenticated implements AuthState {
  const Authenticated({required this.producerId, required this.accessToken,  List<String> roles = const []}): _roles = roles;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is Authenticated&&(identical(other.producerId, producerId) || other.producerId == producerId)&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken)&&const DeepCollectionEquality().equals(other.roles, _roles));
}


@override
int get hashCode {
    return Object.hash(runtimeType,producerId,accessToken,const DeepCollectionEquality().hash(_roles));
}
