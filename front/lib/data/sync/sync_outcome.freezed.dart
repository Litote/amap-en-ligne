...
class SyncSuccess implements SyncOutcome {
  const SyncSuccess({this.hasMore = false,  List<MutationOutcome> rejectedMutations = const <MutationOutcome>[], this.memberOrOwnerUpdated = false}): _rejectedMutations = rejectedMutations;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is SyncSuccess&&(identical(other.hasMore, hasMore) || other.hasMore == hasMore)&&const DeepCollectionEquality().equals(other.rejectedMutations, _rejectedMutations)&&(identical(other.memberOrOwnerUpdated, memberOrOwnerUpdated) || other.memberOrOwnerUpdated == memberOrOwnerUpdated));
}


@override
int get hashCode {
    return Object.hash(runtimeType,hasMore,const DeepCollectionEquality().hash(_rejectedMutations),memberOrOwnerUpdated);
}
