...
class OwnerRepository {
  ...
  ///
  /// Pending back-end support (sync): `OwnerService` does not yet have a
  /// dedicated preferences endpoint; the mutation will be applied once the
  /// server-side handler is in place.
