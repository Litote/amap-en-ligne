...
class ProducerAccountRepository {
  ...
  ///
  /// TODO(sync): The back-end does not yet have a dedicated producer preferences
  /// endpoint on the `producer-account:{id}` scope; the mutation will be
  /// applied once the server-side handler is in place.
