...
void main() {
  ...
  group('Contract subscription helpers', () {
    ...
    const basketSizeSmall = BasketSize(name: 'small');
    ...
    test('keysFromSubscriptions extracts keys from subscriptions', () {
      final subscriptions = [
        const MemberSubscription(productTypeId: productTypeId, basketSize: null),
    ...
    test(
      ...
      () {
        final prices = [
          const ProductPrice(productTypeId: productTypeId, basketSize: null),
          const ProductPrice(productTypeId: 'pt-eggs', basketSize: basketSizeSmall),
        ];
