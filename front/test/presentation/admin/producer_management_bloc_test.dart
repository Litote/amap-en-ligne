...
const _updatedOrg = Organization(
  organizationId: _testOrgId,
  name: 'AMAP Test',
  contactEmail: 'test@amap.fr',
  producers: [
...
void main() {
  ...
  blocTest<ProducerManagementBloc, ProducerManagementState>(
    ...
    build: buildBloc,
    seed: () => const ProducerManagementState.listLoaded(organization: _baseOrg),
    act: (bloc) => bloc.add(
  ...
  blocTest<ProducerManagementBloc, ProducerManagementState>(
    ...
    build: buildBloc,
    seed: () => const ProducerManagementState.detailLoaded(
  ...
  blocTest<ProducerManagementBloc, ProducerManagementState>(
    ...
    build: buildBloc,
    seed: () => const ProducerManagementState.enrollStep2(
      organization: _baseOrg,
      selectedProducer: ProducerAccount(
  ...
  blocTest<ProducerManagementBloc, ProducerManagementState>(
    ...
    build: buildBloc,
    seed: () =>
        const ProducerManagementState.enrollNoAccountStep2(organization: _baseOrg),
    act: (bloc) => bloc.add(
  ...
  blocTest<ProducerManagementBloc, ProducerManagementState>(
    ...
    build: buildBloc,
    seed: () => const ProducerManagementState.listLoaded(
      organization: _baseOrg,
