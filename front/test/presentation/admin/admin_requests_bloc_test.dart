...
const _pending = AdminOrganizationRequest(
  requestId: 'req-1',
...
void main() {
  ...
  blocTest<AdminRequestsBloc, AdminRequestsState>(
    ...
    build: () => AdminRequestsBloc(organizationRequestRepository: repo),
    seed: () => const AdminRequestsState.loaded(
      requests: [_pending],
  ...
  blocTest<AdminRequestsBloc, AdminRequestsState>(
    ...
    build: () => AdminRequestsBloc(organizationRequestRepository: repo),
    seed: () => const AdminRequestsState.loaded(requests: [_pending]),
    act: (bloc) => bloc.add(const AdminRequestsEvent.approveRequested(_pending)),
    expect: () => [
      isA<AdminRequestsLoaded>().having(
  ...
  blocTest<AdminRequestsBloc, AdminRequestsState>(
    ...
    seed: () => const AdminRequestsState.loaded(requests: [_pending]),
    act: (bloc) => bloc.add(
      const AdminRequestsEvent.rejectRequested(
        request: _pending,
  ...
  blocTest<AdminRequestsBloc, AdminRequestsState>(
    ...
    build: () => AdminRequestsBloc(organizationRequestRepository: repo),
    seed: () => const AdminRequestsState.loaded(requests: [_pending]),
    act: (bloc) => bloc.add(const AdminRequestsEvent.resendRequested(_pending)),
    expect: () => [
      isA<AdminRequestsLoaded>().having(
        (s) => s.actionInProgress,
        'actionInProgress',
