...
void main() {
  ...
  blocTest<DeliveryTemplateBloc, DeliveryTemplateState>(
    ...
    setUp: () => when(() => repo.create(any())).thenAnswer((invocation) async => invocation.positionalArguments.single as DeliveryTemplate),
    build: buildBloc,
    act: (bloc) => bloc.add(const DeliveryTemplateEvent.createTemplate(_template)),
    verify: (_) {
  ...
  blocTest<DeliveryTemplateBloc, DeliveryTemplateState>(
    ...
    build: buildBloc,
    act: (bloc) => bloc.add(const DeliveryTemplateEvent.updateTemplate(_template)),
    verify: (_) {
