...
const _member1 = Member(
  memberId: 'member-1',
  organizationId: _testOrgId,
  roles: {Role.volunteer},
);

const _member2 = Member(
  memberId: 'member-2',
  organizationId: _testOrgId,
...
const _invitation = MemberInvitation(
  invitationId: 'inv-1',
  organizationId: _testOrgId,
...
void main() {
  ...
  group('UserManagementBloc', () {
    ...
    blocTest<UserManagementBloc, UserManagementState>(
      ...
      build: buildBloc,
      seed: () => UserManagementState.loaded(members: _members),
      act: (bloc) => bloc.add(const UserManagementEvent.editRolesRequested(_member1)),
      expect: () => [
    ...
    blocTest<UserManagementBloc, UserManagementState>(
      ...
      act: (bloc) => bloc.add(
        const UserManagementEvent.roleToggled(Role.coordinator, isChecked: true),
      ),
      expect: () => [
        isA<UserManagementLoaded>().having(
          (s) => s.pendingRoles,
    ...
    blocTest<UserManagementBloc, UserManagementState>(
      ...
      act: (bloc) => bloc.add(
        const UserManagementEvent.roleToggled(Role.coordinator, isChecked: false),
      ),
      expect: () => [
        isA<UserManagementLoaded>().having(
          (s) => s.pendingRoles,
  ...
  group('invite member', () {
    ...
    blocTest<UserManagementBloc, UserManagementState>(
      ...
      act: (bloc) =>
          bloc.add(const UserManagementEvent.resendInvitationRequested(_invitation)),
      expect: () => [
        isA<UserManagementLoaded>().having(
    ...
    blocTest<UserManagementBloc, UserManagementState>(
      ...
      act: (bloc) =>
          bloc.add(const UserManagementEvent.deleteInvitationRequested(_invitation)),
      expect: () => [
        isA<UserManagementLoaded>().having(
    ...
    blocTest<UserManagementBloc, UserManagementState>(
      ...
      act: (bloc) async {
        bloc
          ..add(const UserManagementEvent.submitInvitation())
          ..add(const UserManagementEvent.submitInvitation());
