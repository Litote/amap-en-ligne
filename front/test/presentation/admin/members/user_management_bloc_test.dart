...
void main() {
  ...
  group('UserManagementBloc', () {
    ...
    blocTest<UserManagementBloc, UserManagementState>(
      ...
      seed: () => UserManagementState.loaded(members: _members),
      act: (bloc) =>
          bloc.add(const UserManagementEvent.editRolesRequested(_member1)),
      expect: () => [
    ...
    blocTest<UserManagementBloc, UserManagementState>(
      ...
      act: (bloc) => bloc.add(
        const UserManagementEvent.roleToggled(
          Role.coordinator,
          isChecked: true,
        ),
      ),
  ...
  group('invite member', () {
    ...
    blocTest<UserManagementBloc, UserManagementState>(
      ...
      act: (bloc) => bloc.add(
        const UserManagementEvent.resendInvitationRequested(_invitation),
      ),
      expect: () => [
        isA<UserManagementLoaded>().having(
    ...
    blocTest<UserManagementBloc, UserManagementState>(
      ...
      act: (bloc) => bloc.add(
        const UserManagementEvent.deleteInvitationRequested(_invitation),
      ),
      expect: () => [
        isA<UserManagementLoaded>().having(
