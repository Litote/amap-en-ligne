  ...
  group('Coordinateurs par contrat', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        when(
          () => organizationRepository.unassignCoordinator(
            currentOrg: any(named: 'currentOrg'),
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        when(
          () => organizationRepository.assignCoordinator(
            currentOrg: any(named: 'currentOrg'),
            deliveryId: any(named: 'deliveryId'),
            contractId: any(named: 'contractId'),
            memberId: any(named: 'memberId'),
  ...
  group('Dérivation des DeliveryContract', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(find.text('Œufs fermiers'), findsOneWidget);
      },
    );
