  ...
  group('Coordinateurs par contrat', () {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        const orgWithContract = Organization(
          organizationId: 'org-1',
          name: 'AMAP Test',
          contactEmail: 'test@amap.fr',
          deliveries: [
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        const orgWithBothCoords = Organization(
          organizationId: 'org-1',
          name: 'AMAP Test',
          contactEmail: 'test@amap.fr',
          deliveries: [
            Delivery(
              ...
              contracts: [
                DeliveryContract(
                  contractId: cId,
                  coordinators: [otherCoordId, meId],
                  basketQuantity: 10,
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        const orgAlreadyCoord = Organization(
          organizationId: 'org-1',
          name: 'AMAP Test',
          contactEmail: 'test@amap.fr',
          deliveries: [
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        const orgInProgress = Organization(
          organizationId: 'org-1',
          name: 'AMAP Test',
          contactEmail: 'test@amap.fr',
          deliveries: [
