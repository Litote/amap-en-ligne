...
void main() {
  ...
  group('CoordinatorDeliveryTrackingScreen — mutations', () {
    ...
    testWidgets(
      'a failing registration update shows the generic error snackbar',
      (tester) async {
        when(
          () => organizationRepository.updateRegistrationStatus(
            currentOrg: any(named: 'currentOrg'),
    ...
    testWidgets(
      'a failing contract status update shows the generic error snackbar',
      (tester) async {
        when(
          () => organizationRepository.updateDeliveryContractStatus(
            currentOrg: any(named: 'currentOrg'),
    ...
    testWidgets('shows the CLÔTURER LA DISTRIBUTION closure entry button', (
      tester,
    ) async {
      final delivery = buildDelivery(
        status: DeliveryStatus.inProgress,
      ...
      expect(find.text('CLÔTURER LA DISTRIBUTION'), findsOneWidget);
