...
void main() {
  ...
  testWidgets('toggling "Contrat principal" persists isMainContract', (
    ...
    final mainSwitch = find.widgetWithText(SwitchListTile, 'Contrat principal');
    await tester.ensureVisible(mainSwitch);
    ...
    final captured = verify(
      () => contractRepository.update(captureAny()),
    ).captured;
    expect((captured.single as Contract).isMainContract, isTrue);
  });
