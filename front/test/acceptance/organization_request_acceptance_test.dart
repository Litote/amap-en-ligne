...
void main() {
  ...
  test('${story.title} [${story.id}]', () async {
    ...
    const pendingRequest = AdminOrganizationRequest(
      requestId: 'req-1',
      organizationName: 'AMAP des Collines',
      timezone: 'Europe/Paris',
      defaultLanguage: 'fr',
    ...
    adminBloc.add(const AdminRequestsEvent.approveRequested(pendingRequest));
    ...
    final memberRepository = _MockMemberRepository();
    when(
