...
void main() {
  ...
  group('mobile storage', () {
    ...
    test('migrates legacy SharedPreferences session to secure storage',
        () async {
    ...
    test('clear removes session from secure storage and legacy prefs',
        () async {
      final secureStorage = _FakeSecureStorageBackend();
      final storage = AdaptiveAuthTokenStorage(
        prefs: await prefs(),
  ...
  group('web storage', () {
    ...
    test('preserves the current persistence mode across refresh writes',
        () async {
      final sessionStorage = _FakeBrowserStorageBackend();
      final localStorage = _FakeBrowserStorageBackend();
      final storage = AdaptiveAuthTokenStorage(
    ...
    test('migrates legacy SharedPreferences sessions to durable storage',
        () async {
