...
void main() {
  ...
  group('EntityPayload (sealed)', () {
    ...
    test('Contract without shared_baskets defaults to empty and omits null anchor', () {
      const json = {
        'type': 'Contract',
        'contract': {
      ...
      final empty = EntityPayload.fromJson({
        'type': 'Contract',
        'contract': {
          'contract_id': 'c-empty',
          'name': 'X',
      ...
      final wire = wireOf(payload);
      final inner = wire['contract'] as Map<String, dynamic>;
      final wireBasket = (inner['shared_baskets'] as List).first as Map<String, dynamic>;
