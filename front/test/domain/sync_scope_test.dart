  ...
  group('scopeKeyForPayload', () {
    test('covers every payload type', () {
      ...
      expect(
        scopeKeyForPayload(
          const MemberPayload(
            member: Member(memberId: 'member-1', organizationId: 'org-1'),
          ),
        ),
        organizationScopeKey('org-1'),
      );
      ...
      expect(
        scopeKeyForPayload(
          const OrganizationRequestPayload(
            organizationRequest: AdminOrganizationRequest(
              requestId: 'req-1',
