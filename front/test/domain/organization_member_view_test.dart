...
void main() {
  ...
  group('seasonLabel', () {
    ...
    test('malformed dates fall back to now.year', () {
      final contract = makeContract(
        id: 'c-1',
        seasonYear: 2026,
        minDate: 'not-a-date',
    ...
    test('contract with malformed dates is ignored when another is valid', () {
      final malformed = makeContract(
        id: 'c-bad',
        seasonYear: 2026,
        minDate: 'not-a-date',
        maxDate: 'also-not-a-date',
      );
      final valid = makeContract(
        id: 'c-good',
        seasonYear: 2026,
        minDate: '2026-04-01',
        maxDate: '2027-03-31',
      );
      expect(seasonLabel([malformed, valid], 2026, now), 'Saison 2026-2027');
    });
  });
