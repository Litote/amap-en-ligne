...
class ErrorReportSyncDynamoDAOTest : ErrorReportSyncDAOContractTest() {
    private val dynamoClient = DynamoTestInfra.newClient()
    override val errorReportSyncDAO: ErrorReportSyncDAO = ErrorReportSyncDynamoDAO(dynamoClient)
