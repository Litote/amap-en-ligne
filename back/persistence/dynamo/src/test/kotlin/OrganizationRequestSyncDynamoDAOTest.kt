...
class OrganizationRequestSyncDynamoDAOTest : OrganizationRequestSyncDAOContractTest() {
    private val dynamoClient = DynamoTestInfra.newClient()
    override val organizationRequestSyncDAO: OrganizationRequestSyncDAO = OrganizationRequestSyncDynamoDAO(dynamoClient)
