...
private const val VALUE_ENTITY_TYPE = ":entity_type"
private const val VALUE_PK_PREFIX = ":pk_prefix"
private const val FILTER_BY_ID = "entity_type = :entity_type AND begins_with(pk, :pk_prefix) AND sk = :sk"
        ...
        val response =
            client.client.scan(
                ScanRequest {
                    ...
                    expressionAttributeValues =
                        mapOf(
                            VALUE_ENTITY_TYPE to AttributeValue.S("ProducerAccount"),
                            VALUE_PK_PREFIX to AttributeValue.S("PA#"),
                        )
                },
            )
