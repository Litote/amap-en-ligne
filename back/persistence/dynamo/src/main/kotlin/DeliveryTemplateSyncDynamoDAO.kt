...
internal class DeliveryTemplateSyncDynamoDAO(
    ...
    override suspend fun put(
        ...
        client.transactPutEntityAndChange(deliveryTemplate.toAttributeValueMap(), change)
    }
    ...
    override suspend fun delete(
        ...
        client.transactDeleteEntityAndChange("DLVTMPL#${organizationId.id}", deliveryTemplateId.id, change)
    }
}
