...
internal class BasketExchangeSyncDynamoDAO(
    ...
    override suspend fun put(
        ...
        client.transactPutEntityAndChange(basketExchange.toAttributeValueMap(), change)
    }
    ...
    override suspend fun delete(
        ...
        client.transactDeleteEntityAndChange("BSKEX#${organizationId.id}", basketExchangeId.id, change)
    }
}
