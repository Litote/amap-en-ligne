...
internal class DeviceTokenSyncDynamoDAO(
    ...
    override suspend fun put(
        ...
        client.transactPutEntityAndChange(deviceToken.toAttributeValueMap(), change)
    }
    ...
    override suspend fun delete(
        ...
        client.transactDeleteEntityAndChange(pk(recipientScope), deviceTokenId.id, change)
    }
