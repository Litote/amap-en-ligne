...
internal class NotificationSyncDynamoDAO(
    ...
    override suspend fun put(
        ...
        client.transactPutEntityAndChange(notification.toAttributeValueMap(), change)
    }
    ...
    override suspend fun delete(
        ...
        client.transactDeleteEntityAndChange(pk(recipientScope), notificationId.id, change)
    }
