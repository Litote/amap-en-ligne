...
enum class MutationErrorCode {
    ...
    /**
     * Unexpected server-side failure while applying the mutation (persistence outage, bug).
     * Transient from the client's point of view: the client must keep the mutation queued
     * and retry it on a later sync instead of dropping it.
     */
    INTERNAL_ERROR,
