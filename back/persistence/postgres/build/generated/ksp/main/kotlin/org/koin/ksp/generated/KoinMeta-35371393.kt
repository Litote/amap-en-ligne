...
@MetaDefinition("persistence.postgres.AppliedClientOpPostgresDAO",moduleTagId="g128ff:PersistencePostgresPostgresModule", dependencies=["client:persistence.postgres.PostgresClient"], binds=["persistence.dao.AppliedClientOpDAO"])
public class _KSP_PersistencePostgresAppliedClientOpPostgresDAO
@MetaDefinition("persistence.postgres.AppliedClientOpPostgresDAO",moduleTagId="g128ff:PersistencePostgresPostgresModule", dependencies=["client:persistence.postgres.PostgresClient"], binds=["persistence.dao.AppliedClientOpDAO"])
public val _KSP_PersistenceDaoAppliedClientOpDAO : Unit get() = Unit