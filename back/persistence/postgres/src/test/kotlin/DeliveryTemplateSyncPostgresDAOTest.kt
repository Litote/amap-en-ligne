...
class DeliveryTemplateSyncPostgresDAOTest : DeliveryTemplateSyncDAOContractTest() {
    private val container = PostgreSQLContainer("postgres:16")
    private lateinit var postgresClient: PostgresClient

    override val deliveryTemplateSyncDAO: DeliveryTemplateSyncDAO by lazy {
        DeliveryTemplateSyncPostgresDAO(postgresClient)
    }
