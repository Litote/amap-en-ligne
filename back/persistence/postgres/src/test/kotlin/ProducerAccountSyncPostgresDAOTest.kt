...
class ProducerAccountSyncPostgresDAOTest : ProducerAccountSyncDAOContractTest() {
    private val container = PostgreSQLContainer("postgres:16")
    private lateinit var postgresClient: PostgresClient

    override val producerAccountSyncDAO: ProducerAccountSyncDAO by lazy { ProducerAccountSyncPostgresDAO(postgresClient) }
