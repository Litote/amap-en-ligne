...
--
-- Name: applied_client_op; Type: TABLE; Schema: public; Owner: -
--

-- Idempotency records for APPLIED sync mutations, keyed by the client-chosen
-- client_op_id. Replayed mutations short-circuit to the stored outcome.
-- No TTL/cleanup in v1 (accepted limitation): rows are tiny and offline
-- queues drain quickly; a periodic DELETE on applied_at can come later.
CREATE TABLE public.applied_client_op (
...
CREATE TABLE public.contract (
    ...
    shared_baskets jsonb DEFAULT '[]'::jsonb NOT NULL,
    is_main_contract boolean DEFAULT false NOT NULL
);
...
--
-- Name: applied_client_op applied_client_op_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.applied_client_op
    ADD CONSTRAINT applied_client_op_pkey PRIMARY KEY (client_op_id);
