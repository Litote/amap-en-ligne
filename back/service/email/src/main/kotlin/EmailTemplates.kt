...
object EmailTemplates {
            ...
            invitation.customEmailBody?.takeIf { it.isNotBlank() }
                ?: (
                    "Bonjour ${invitation.firstName} ${invitation.lastName},\n\n" +
                        "Vous avez été invité(e) à rejoindre votre AMAP sur AMAP en ligne."
                )
    ...
    fun ownerActivation(
        ...
        EmailContent(
            ...
            body =
                "Bonjour ${invitation.firstName} ${invitation.lastName},\n\n" +
                    "Vous avez été invité(e) à devenir administrateur de l'instance AMAP en ligne.\n\n" +
                    activationFooter(activationUrl, expiresAt) +
                    SIGNATURE,
        )
        ...
        EmailContent(
            ...
            body =
                "Bonjour,\n\n" +
                    ...
                    "Connectez-vous à l'espace d'administration pour l'examiner." +
                    SIGNATURE,
        )
