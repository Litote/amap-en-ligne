...
/**
 * The displayable content of a notification: the copy ([title] / [body]) plus optional
 * navigation hints ([deepLink] / [relatedEntityId]). Bundled so [NotificationPublisher.publish]
 * stays within a reasonable parameter count.
 */
