            ...
            .forEach { owner ->
                runCatching {
                    notificationPublisher.publish(
                        ...
                        category = category,
                        content = NotificationContent(title = title, body = body, relatedEntityId = relatedEntityId),
            ...
            .forEach { admin ->
                ...
                runCatching {
                    notificationPublisher.publish(
                        ...
                        type = NotificationType.INFO,
                        category = category,
                        content = NotificationContent(title = copy.title, body = copy.body, relatedEntityId = relatedEntityId),
