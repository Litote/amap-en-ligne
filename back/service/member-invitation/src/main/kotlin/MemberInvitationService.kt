...
class MemberInvitationService(
    ...
    private suspend fun createInvitation(
        ...
        if (memberExists) {
            return rejected(mutation, MutationErrorCode.UNIQUE_VIOLATION, "email already has a pending invitation")
        }
        ...
        return try {
            ...
            rejected(mutation, MutationErrorCode.UNIQUE_VIOLATION, "email already has a pending invitation")
        }
    }
