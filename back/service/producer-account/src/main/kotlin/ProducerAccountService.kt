...
class ProducerAccountService(
    ...
    /** Mode/identity invariants checked before any normalization. */
    ...
    /** The single organization a NO_ACCOUNT producer is pinned to (existing link wins, else incoming, else the caller org). */
