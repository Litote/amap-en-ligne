...
5. Activez **« Contrat principal »** si ce contrat mobilise des bénévoles (par exemple les légumes). Seuls les contrats principaux génèrent des créneaux bénévoles et comptent dans le besoin « N/M bénévoles » des livraisons ; les contrats secondaires (œufs, fruits…) ne demandent que le coordinateur. La bascule est désactivée par défaut.
6. Ajoutez éventuellement des **coordinateurs référents** (voir ci-dessous).
7. Cochez éventuellement les **amapiens à rattacher** (voir ci-dessous).
8. Touchez **[ENREGISTRER LE CONTRAT]**.
